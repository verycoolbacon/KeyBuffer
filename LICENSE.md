...
* Remove or change this license in a way that removes or conflicts with these rules.

## CREDIT

If you use my code, you **MUST** credit:

**verycoolbacon**

If you only make something inspired by my work without using my code directly, credit is encouraged but not required.

If you only use a small part of my code, you must credit me, but you do not necessarily have to open source your project.

## MODIFIED VERSIONS

If your project is clearly based on my code and you make major modifications:

* You **MUST** open source the modified code.
* You **MUST** credit **verycoolbacon**.

If you only make small changes, such as changing variable names, formatting, or comments:

* You **MUST** credit **verycoolbacon**.
* You do not have to open source the project.

If you translate my code into another programming language while keeping its basic logic, structure, and content:

* You **MUST** open source it.
* You **MUST** credit **verycoolbacon**.

If my code is only used as a dependency or library without copying the code into your project:

* You only need to credit me.
...
A private repository is considered private use only while nobody else has access to the code.
...
If my script is used in a paid product, contact me first.

I will check how much my script is used in the product and decide whether it is allowed.

If you put my script into a paid product without contacting me first:

* You are violating this license.
* You must remove my script from the product immediately.

A company making money does not automatically count as commercial use. If my script is not being directly used for commercial purposes, the company simply making money does not by itself violate this license.

## SHARING

If you share my code with another person, that person must follow the full license.

This also applies to school projects, private Discord servers, screenshots of my code, and other situations where someone besides you can see the code.

If you publish my code in a public GitHub repository, you must follow the full license.

If you publish a project containing my code, the credit must be placed somewhere people can reasonably see it.

## LICENSE AND CREDIT REMOVAL

If you remove my credit:
...
My code may not be used as AI training data without my permission.

If I give permission, it may be used for AI training.
...
If you have questions or want permission for something not covered by this license, contact me:

**Discord: verycoolbacon_**

© 2026 verycoolbacon. All rights reserved.

--- BELOW HERE IS WRITTEN BY VERYCOOLBACON ---

--- random bullshit ---

i know this license is bullshit. just contact that stupid guy
this license was drafted with help from ChatGPT (GPT-5.6 Luna)
fuck it i cant write a license
yea just fucking contact me if u have any problems with this bullshit
im extremely sorry for changing the license tho

--- ABOVE HERE IS WRITTEN BY VERYCOOLBACON ---
